...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")]),_v(" "),_c('li',[_v("National University of Singapore students")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a new person")]),_v(" "),_c('td',[_v("store and retrieve essential information easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a person")]),_v(" "),_c('td',[_v("remove entries that are no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("find a person by name")]),_v(" "),_c('td',[_v("quickly locate specific individuals")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("edit contact details")]),_v(" "),_c('td',[_v("keep their details up-to-date")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("sort contact details")]),_v(" "),_c('td',[_v("keep their details in an orderly manner")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("list contact details")]),_v(" "),_c('td',[_v("view and manage contacts more efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("remember my last search")]),_v(" "),_c('td',[_v("don't need to type it again")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("set birthday reminders for my contacts")]),_v(" "),_c('td',[_v("be notified in advance")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user with many persons in the address book")]),_v(" "),_c('td',[_v("search for contacts fuzzily")]),_v(" "),_c('td',[_v("find a person even if I do not correctly know their names")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user with many persons in the address book")]),_v(" "),_c('td',[_v("the application to load quickly")]),_v(" "),_c('td',[_v("access my information without delay")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Delete a person based on index")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons (e.g., using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command).")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons with their "),_c('strong',[_v("Name, Phone, Email, Address, Major and Tags(if any)")]),_v(" in an indexed format.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list by index (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 3")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook prompts a popup box to request user to confirm their deletion.")])]),_v(" "),_c('li',[_c('p',[_v("User enters the confirm button.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the person with the given index.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook informs the user that there are no contacts to delete.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_c('strong',[_v("Use case")]),_v(" resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. Cancel button or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("x")]),_v(" was pressed.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("4a1. Contact is not deleted. Deletion canceled.")]),_v(" "),_c('p',[_c('strong',[_v("Use case")]),_v(" resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Delete person(s) based on tags")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons (e.g., using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command).")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons with their "),_c('strong',[_v("Name, Phone, Email, Address, Major and Tags(if any)")]),_v(" in an indexed format.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list by the tags (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete t/HSA1000")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook prompts a popup box to request user to confirm their deletion.")])]),_v(" "),_c('li',[_c('p',[_v("User enters the confirm button.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the person with the given index.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new person by specifying "),_c('strong',[_v("Name, Phone, Email, Address, Major and Tags(if any)")]),_v("\n(e.g., using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/NAME p/PHONE e/EMAIL a/ADDRESS m/MAJOR t/[TAGS]")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook validates the details (e.g., checks phone format, email format, etc.).")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook saves the new person to the address book.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. User provides incomplete or invalid details. (e.g., phone number format is invalid)")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])]),_v(" "),_c('li',[_c('p',[_v("2b. User tries to add a contact that already exists (e.g., same "),_c('strong',[_v("Name and Phone")]),_v(").")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. AddressBook rejects the duplicate entry and shows an error message.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters a "),_c('strong',[_v("search term")]),_v(". (e.g., using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find KEYWORD")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook searches for any "),_c('strong',[_v("matching persons")]),_v(" based on the search term in their\n"),_c('strong',[_v("Name, Phone, Email, Major")]),_v(" and "),_c('strong',[_v("Tags")]),_v(".")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. No matching persons found\n"),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook informs the user that no results match the search.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons (e.g., using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command).")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit a specific person.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook updates the details of the person.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.\n"),_c('strong',[_v("Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. AddressBook shows an error message.\nUse case resumes at step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("3b. The new tags entered by user are of invalid format.")]),_v(" "),_c('ul',[_c('li',[_v("3b1. AddressBook shows an error message.\nUse case resumes at step 3.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters a "),_c('strong',[_v("sort command")]),_v(" with a specified order (e.g., using 'sort asc' or 'sort desc').")])]),_v(" "),_c('li',[_c('p',[_v("Sorts the contact list in the specified order based on "),_c('strong',[_v("Name")]),_v(", followed by "),_c('strong',[_v("Phone Number")]),_v(" if names are identical.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays the sorted contact list.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. No contacts found in the list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook informs the user that there are no contacts to sort.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])]),_v(" "),_c('li',[_c('p',[_v("2b. User enters an invalid sorting order.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. AddressBook informs the user of the invalid input and provides the correct format.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Hide/Unhide")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User performs a hide or unhide.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook automatically hides the contact details of persons in CollabSync")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Save Data")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User performs an action that modifies the data (e.g., adding, editing, or deleting a contact).")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook automatically saves the updated data to a local file (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("data/addressbook.json")]),_v(").")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. Saving data fails (e.g., permission issues or disk is full).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook shows an error message indicating that the save failed.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])]),_v(" "),_c('li',[_c('p',[_v("2b. Data file is corrupted or unreadable.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. AddressBook shows an error message about the corrupted file.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 18:28:15 GMT+8]")])])])}
}];
