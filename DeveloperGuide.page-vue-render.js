...
with(this){return _c('h3',{attrs:{"id":"backup-on-corrupt-workflow"}},[_v("Backup on corrupt workflow"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#backup-on-corrupt-workflow","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"addcommand-workflow"}},[_v("AddCommand workflow"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#addcommand-workflow","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommand")]),_v(" is part of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" layer in the application and handles the action of adding the contact. "),_c('br')])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommand")]),_v(" is invoked when the user types the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(". This is handled in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(Model model)")]),_v(" method of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommand")]),_v(" class. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" object, which represents the application's data layer, is passed into the method.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommand")]),_v(" will query "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" object with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hasPerson()")]),_v(" to ensure no duplicate student before adding.")]),_v(" "),_c('li',[_v("If "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hasPerson()")]),_v(" return false, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommand")]),_v(" will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addPerson()")]),_v(" of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" object to add the new student.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"editcommand-workflow"}},[_v("EditCommand workflow"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#editcommand-workflow","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(" is part of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" layer in the application and handles the action of adding the contact. "),_c('br')])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(" is invoked when the user types the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(". This is handled in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(Model model)")]),_v(" method of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(" class. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" object, which represents the application's data layer, is passed into the method.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(" requests the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" to retrieve the filtered list of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" objects via the method call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.getFilteredPersonList()")]),_v(". This call is made to fetch all the students that the user has in the current view (filtered according to certain criteria).")]),_v(" "),_c('li',[_v("If the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(" paramter is valid, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(" will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("createEditedPerson()")]),_v(" to create a new student with updated details.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(" then invoke "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setPerson()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updateFilteredPersonList()")]),_v(" methods of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" object to update the student.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"deletecommand-workflow"}},[_v("DeleteCommand workflow"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#deletecommand-workflow","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(" is part of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" layer in the application and handles the action of deleting the contact(s). "),_c('br')])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(" is invoked when the user types the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(". This is handled in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(Model model)")]),_v(" method of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(" class. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" object, which represents the application's data layer, is passed into the method.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(" requests the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" to retrieve the filtered list of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" objects via the method call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.getFilteredPersonList()")]),_v(". This call is made to fetch all the students that the user has in the current view (filtered according to certain criteria).")]),_v(" "),_c('li',[_v("Before "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(" continues it's execution, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(" will first check the format of the parameters to determine user wants to delete with tags or index.")]),_v(" "),_c('li',[_v("Next, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(" will prompt user for confirmation before proceed with deletion.")]),_v(" "),_c('li',[_v("If the command format matches "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete INDEX")]),_v(", the system invokes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteWithIndex()")]),_v(". This method retrieves the target "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object based on the provided index, then calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletePerson()")]),_v(" from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" object to remove the student.")]),_v(" "),_c('li',[_v("If the command format matches "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete t/TAG [ ,t/TAGS]")]),_v(", the system invokes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteWithTag()")]),_v(". This method filters the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("List<Person>")]),_v(" to find entries matching any of the specified tags (using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hasTags()")]),_v("). Deletes all matched students by calling "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletePerson()")]),_v(" from the Model object.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HideCommand")]),_v(" is invoked when the user types the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hide")]),_v(". This is handled in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(Model model)")]),_v(" method of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HideCommand")]),_v(" class. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" object, which represents the application's data layer, is passed into the method.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HideCommand")]),_v(" requests the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" to retrieve the filtered list of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" objects via the method call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.getFilteredPersonList()")]),_v(". This call is made to fetch all the students that the user has in the current view (filtered according to certain criteria).")]),_v(" "),_c('li',[_v("Once the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filteredPersonList")]),_v(" is retrieved, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HideCommand")]),_v(" iterates over each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object in the list and calls the method "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("person.hideDetails()")]),_v(". This hides the details of each student in the list. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hideDetails()")]),_v(" method, which is part of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" class, modifies the internal state of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object, essentially \"hiding\" the contact's details from the user interface.")]),_v(" "),_c('li',[_v("After the details are hidden, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HideCommand")]),_v(" returns a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" indicating the success of the operation. The message "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Contact details hidden.\"")]),_v(" is passed to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" constructor, along with additional flags that help the UI decide how to update (whether to show a success message or not).")]),_v(" "),_c('li',[_v("The UI layer will use the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" object to display feedback to the user. If successful, the system will notify the user that the contact's details have been hidden.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"ui-update-behavior"}},[_v("UI Update Behavior"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#ui-update-behavior","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Model State Update:")]),_c('br'),_v("\nAfter "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hideDetails()")]),_v(" is called on each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(", the internal "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("areDetailsVisible")]),_v(" property is set to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("false")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Automatic UI Refresh via Data Binding:")]),_c('br'),_v("\nIn the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonCard")]),_v(" component, the UI elements (such as phone, email, address, and major) are bound to the person's "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("detailsVisibleProperty()")]),_v(". For example:")]),_v(" "),_c('pre',[_c('code',{pre:true,attrs:{"class":"hljs java"}},[_c('span',[_v("phone.visibleProperty().bind(person.detailsVisibleProperty());\n")]),_c('span',[_v("phone.managedProperty().bind(person.detailsVisibleProperty());\n")]),_c('span',[_v("\n")]),_c('span',[_v("address.visibleProperty().bind(person.detailsVisibleProperty());\n")]),_c('span',[_v("address.managedProperty().bind(person.detailsVisibleProperty());\n")]),_c('span',[_v("\n")]),_c('span',[_v("email.visibleProperty().bind(person.detailsVisibleProperty());\n")]),_c('span',[_v("email.managedProperty().bind(person.detailsVisibleProperty());\n")]),_c('span',[_v("\n")]),_c('span',[_v("major.visibleProperty().bind(person.detailsVisibleProperty());\n")]),_c('span',[_v("major.managedProperty().bind(person.detailsVisibleProperty());\n")])])]),_c('p',[_v("With these bindings in place, when "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("areDetailsVisible")]),_v(" is set to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("false")]),_v(", these labels automatically become invisible and are excluded from layout calculations.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("UI Outcome:")]),_v("\nAs a result, once the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HideCommand")]),_v(" is executed:")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("The UI refreshes automatically.")])]),_v(" "),_c('li',[_c('p',[_v("The student’s detailed information (phone, email, address, major) is hidden.")])]),_v(" "),_c('li',[_c('p',[_v("Only the basic details (such as the name and tags) remain visible.")])])]),_v(" "),_c('p',[_v("If the user issues an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unhide")]),_v(" command, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("showDetails()")]),_v(" method is invoked, setting "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("areDetailsVisible")]),_v(" back to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("true")]),_v(" and causing the UI to re-render the full details.")])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"findcommand-workflow"}},[_v("FindCommand workflow"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#findcommand-workflow","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(" is part of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" layer and handles searching for students based on keywords."),_c('br'),_v("\nThis operation is executed when the user triggers the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command in the system.")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The user types the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find KEYWORD...")]),_v(". This is handled in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(Model model)")]),_v(" method of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(" class.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(" creates a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonContainsKeywordsPredicate")]),_v(" object with the specified keywords.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(" calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.updateFilteredPersonList(Predicate<Person>)")]),_v(" to update the filtered list of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" objects. This filters out any students whose names do not match the given keywords.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommand")]),_v(" calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.getFilteredPersonList()")]),_v(" to get the size of the list displayed.")]),_v(" "),_c('li',[_v("A "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" is returned, containing a success message that indicates how many students were found (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"X persons listed!\"")]),_v(").")]),_v(" "),_c('li',[_v("The UI layer reads the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" and refreshes the display to show only those students who match the keywords.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"sortcommand-workflow"}},[_v("SortCommand Workflow"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#sortcommand-workflow","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SortCommand")]),_v(" is part of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" layer and handles searching for students based on keywords."),_c('br'),_v("\nThis operation is executed when the user triggers the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command in the system. "),_c('br'),_v("\nIf identical names are in the contact, the contacts will be sorted using their phone numbers.")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The user enters the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort asc")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort desc")]),_v(".")]),_v(" "),_c('li',[_v("In the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(Model model)")]),_v(" method of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SortCommand")]),_v(", the following steps occur:\n"),_c('ul',[_c('li',[_v("The model is checked to ensure it is not null.")]),_v(" "),_c('li',[_v("The filtered student list is retrieved via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.getFilteredPersonList()")]),_v(".")]),_v(" "),_c('li',[_c('strong',[_v("Empty List Check:")]),_c('br'),_v("\nIf the list is empty, the command immediately returns a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" with the message "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"No contacts to sort.\"")])]),_v(" "),_c('li',[_c('strong',[_v("Sorting Comparator:")]),_c('br'),_v("\nA comparator is defined that first compares students by name, and in cases where names are equal, by phone number:"),_c('pre',[_c('code',{pre:true,attrs:{"class":"hljs java"}},[_c('span',[_v("Comparator<Person> comparator = Comparator.comparing(Person::getName)\n")]),_c('span',[_v("        .thenComparing(Person::getPhone);\n")])])])]),_v(" "),_c('li',[_c('strong',[_v("Order Adjustment:")]),_c('br'),_v("\nIf the command is to sort in descending order ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("isAscending")]),_v(" is false), the comparator is reversed.")]),_v(" "),_c('li',[_c('strong',[_v("Sorting the List:")]),_c('br'),_v("\nThe comparator is then passed to the model via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.sortFilteredPersonList(comparator)")]),_v(", which reorders the filtered list.")]),_v(" "),_c('li',[_c('strong',[_v("Result Generation:")]),_c('br'),_v("\nFinally, a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" is created with a message indicating the sort order, e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Contacts sorted in ascending order.\"")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Contacts sorted in descending order.\"")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new student by specifying "),_c('strong',[_v("Name, Phone, Email, Address, Major and Tags(if any)")]),_v("\n(e.g., using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/NAME p/PHONE e/EMAIL a/ADDRESS m/MAJOR t/[TAGS]")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync validates the details (e.g., checks phone format, email format, etc.).")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync saves the new student to the address book.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"use-case-delete-a-student-based-on-index"}},[_v("Use case: Delete a student based on index"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-delete-a-student-based-on-index","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list students (e.g., using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command).")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync shows a list of students with their "),_c('strong',[_v("Name, Phone, Email, Address, Major and Tags(if any)")]),_v(" in an indexed format.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific student in the list by index (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 3")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync prompts a popup box to request user to confirm their deletion.")])]),_v(" "),_c('li',[_c('p',[_v("User enters the confirm button.")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync deletes the student with the given index.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('h4',{attrs:{"id":"use-case-delete-student-s-based-on-tags"}},[_v("Use case: Delete student(s) based on tags"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-delete-student-s-based-on-tags","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list students (e.g., using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command).")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync shows a list of students with their "),_c('strong',[_v("Name, Phone, Email, Address, Major and Tags(if any)")]),_v(" in an indexed format.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific student in the list by the tags (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete t/HSA1000")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync prompts a popup box to request user to confirm their deletion.")])]),_v(" "),_c('li',[_c('p',[_v("User enters the confirm button.")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync deletes the student with the given index.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list students (e.g., using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command).")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync shows a list of students.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit a specific student.")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync updates the details of the student.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hide")]),_v(" command.")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync automatically hides the contact details of all students currently shown in the application, except for "),_c('strong',[_v("Name and Tags")]),_v(" (if they were displayed previously).")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unhide")]),_v(" command.")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync automatically reveals all the hidden information of the students currently in the application.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters a "),_c('strong',[_v("search term")]),_v(". (e.g., using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find KEYWORD")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("CollabSync searches for any "),_c('strong',[_v("matching students")]),_v(" based on the search term in their\n"),_c('strong',[_v("Name, Phone, Email, Major")]),_v(" and "),_c('strong',[_v("Tags")]),_v(".")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. No matching students found\n"),_c('ul',[_c('li',[_c('p',[_v("2a1. CollabSync informs the user that no results match the search.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"difficulty-level-for-the-project"}},[_v("Difficulty Level for the Project"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#difficulty-level-for-the-project","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"challenges-faced-for-the-project"}},[_v("Challenges Faced for the Project"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#challenges-faced-for-the-project","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Challenge 1 : Revamping the UI to make our application look more appealing to users through various coloured words and tags.")]),_v(" "),_c('li',[_v("Challenge 2 : Addition of the newer features such as the introduction of corrupt data handling for corrupted files.")]),_v(" "),_c('li',[_v("Challenge 3 : Intense workload due to a 4-person team.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"effort-required-for-the-project"}},[_v("Effort Required for the Project"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#effort-required-for-the-project","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Various, new commands are added while existing commands are refined to better cater to university students more closely for CollabSync.")]),_v(" "),_c('li',[_v("Refactoring of code to ensure our code follows certain principles taught in the CS2103T module: No deep nesting, KISS, SLAP and so on.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"achievements-of-the-project"}},[_v("Achievements of the Project"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#achievements-of-the-project","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Refine the warning message for edit")]),_v(" : For edit command, when one enters a large index value, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 100000000000000")]),_v(" , the warning message does not show "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("At least one field to edit must be provided.")]),_v(" due to buffer overflow errors. Instead, it shows\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Invalid command format! [More error message ....]")]),_v(". It would be good to fix this in future.")]),_v(" "),_c('li',[_c('strong',[_v("Enhanced parameter validation")]),_v(" : Unnecessary parameters provided with commands, such as entering "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("help 12345")]),_v(", will trigger a clear warning message that indicates the correct usage. This enhancement ensures that users receive immediate feedback, guiding them to use commands as intended and reducing potential confusion.")]),_v(" "),_c('li',[_c('strong',[_v("Help Window refinement")]),_v(" : As a future enhancement, we plan to implement dedicated help commands for each command entered.\nFor example, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("help add")]),_v(" allows users to seek help on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command specifically. This refinement offers users a more detailed, feature-specific guidance on the respective commands. This will make it easier for users to understand and effectively utilize each command, thereby enhancing overall usability and user experience.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 23:51:57 GMT+8]")])])])}
}];
