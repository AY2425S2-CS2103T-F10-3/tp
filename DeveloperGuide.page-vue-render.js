...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.\n"),_c('strong',[_v("Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. AddressBook shows an error message."),_c('br'),_v("\nUse case resumes at step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("4a. The new details are invalid.")]),_v(" "),_c('ul',[_c('li',[_v("4a1. AddressBook shows an error message."),_c('br'),_v("\nUse case resumes at step 3.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 25 Mar 2025, 20:44:00 GMT+8]")])])])}
}];
