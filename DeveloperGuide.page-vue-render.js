...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons (e.g., using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command).")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons with their "),_c('strong',[_v("Name, Phone, Email and Address")]),_v(" in an indexed format.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list by index (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 3")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the person with the given index.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook informs the user that there are no contacts to delete.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_c('strong',[_v("Use case")]),_v(" resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new person by specifying "),_c('strong',[_v("Name, Phone, Email, and Address")]),_v("\n(e.g., using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/NAME p/PHONE e/EMAIL a/ADDRESS")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook validates the details (e.g., checks phone format, email format, etc.).")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook saves the new person to the address book.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit a specific person.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook updates the details of the person.")]),_v(" "),_c('p',[_c('strong',[_v("Use case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.\n"),_c('strong',[_v("Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. AddressBook shows an error message.\nUse case resumes at step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("4a. The new details are invalid.")]),_v(" "),_c('ul',[_c('li',[_v("4a1. AddressBook shows an error message.\nUse case resumes at step 3.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 3:40:53 GMT+8]")])])])}
}];
