...
with(this){return _c('li',[_c('strong',[_v("Verify the setup")]),_v(":\n"),_c('ol',[_c('li',[_v("Run the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("seedu.address.setup.Main")]),_v(" and try a few commands.")]),_v(" "),_c('li',[_c('a',{attrs:{"href":"/tp/Testing.html"}},[_v("Run the tests")]),_v(" to ensure they all pass.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Configure the coding style")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("If using IDEA, follow the guide "),_c('a',{attrs:{"href":"https://se-education.org/guides/tutorials/intellijCodeStyle.html"}},[_c('em',[_v("[se-edu/guides] IDEA: Configuring the code style")])]),_v(" to set up IDEA's coding style to match ours.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 14:19:41 GMT+8]")])])])}
}];
