...
public class ParserUtilTest {
    ...
    private static final String INVALID_MAJOR = "M@th";
    ...
    private static final String VALID_MAJOR = "Math";
    ...
    public void parseTag_validValueWithoutWhitespace_returnsTag() throws Exception {
        Tag expectedTag = new Tag(VALID_TAG_1, Priority.NONE);
    ...
    public void parseTags_collectionWithValidTags_returnsTagSet() throws Exception {
        ...
        Set<Tag> expectedTagSet = new HashSet<Tag>(Arrays.asList(new Tag(VALID_TAG_1, Priority.NONE),
                new Tag(VALID_TAG_2, Priority.NONE)));
